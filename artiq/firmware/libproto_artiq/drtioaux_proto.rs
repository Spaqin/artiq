...
impl Payload {
        ...
        where R: Read + ?Sized
    {
        Ok(match reader.read_u8()? {
            ...
            0xd0 => Payload::CoreMgmtGetLogRequest {
                clear: reader.read_bool()?,
            },
            0xd1 => Payload::CoreMgmtClearLogRequest,
            0xd2 => Payload::CoreMgmtSetLogLevelRequest {
                log_level: reader.read_u8()?,
            },
            0xd3 => Payload::CoreMgmtSetUartLogLevelRequest {
                log_level: reader.read_u8()?,
            },
            0xd4 => {
                let length = reader.read_u16()?;
            ...
            0xd5 => Payload::CoreMgmtConfigReadContinue,
            0xd6 => {
                let last = reader.read_bool()?;
                let length = reader.read_u16()?;
                let mut data: [u8; DRTIO_ID_PAYLOAD_SIZE] = [0; DRTIO_ID_PAYLOAD_SIZE];
            ...
            0xd8 => Payload::CoreMgmtConfigEraseRequest,
            0xd9 => Payload::CoreMgmtRebootRequest,
            0xda => Payload::CoreMgmtAllocatorDebugRequest,
            0xdb => Payload::CoreMgmtFlashRequest {
            ...
            0xdd => Payload::CoreMgmtDropLinkAck,
            0xde => Payload::CoreMgmtDropLink,
            0xdf => {
                let last = reader.read_bool()?;
                let length = reader.read_u16()?;
                let mut data: [u8; DRTIO_PAYLOAD_SIZE] = [0; DRTIO_PAYLOAD_SIZE];
        ...
        where W: Write + ?Sized
    {
        match *self {
            ...
            Payload::CoreMgmtGetLogRequest { clear } => {
                writer.write_u8(0xd0)?;
                writer.write_bool(clear)?;
            },
            Payload::CoreMgmtClearLogRequest => 
                writer.write_u8(0xd1)?,
            Payload::CoreMgmtSetLogLevelRequest { log_level } => {
                writer.write_u8(0xd2)?;
                writer.write_u8(log_level)?;
            },
            Payload::CoreMgmtSetUartLogLevelRequest { log_level } => {
            ...
            Payload::CoreMgmtConfigReadContinue => 
            ...
            Payload::CoreMgmtConfigEraseRequest => 
                writer.write_u8(0xd8)?,
            Payload::CoreMgmtRebootRequest =>
                writer.write_u8(0xd9)?,
            Payload::CoreMgmtAllocatorDebugRequest =>
                writer.write_u8(0xda)?,
            Payload::CoreMgmtFlashRequest { payload_length } => {
                writer.write_u8(0xdb)?;
                writer.write_u32(payload_length)?;
            },
            Payload::CoreMgmtFlashAddDataRequest { last, length, data } => {
            ...
            Payload::CoreMgmtDropLink => 
                writer.write_u8(0xde)?,
            Payload::CoreMgmtGetLogReply { last, length, data } => {
                writer.write_u8(0xdf)?;
                writer.write_bool(last)?;
                writer.write_u16(length)?;
                writer.write_all(&data[0..length as usize])?;
            },
            Payload::CoreMgmtConfigReadReply { last, length, value } => {
                writer.write_u8(0xe0)?;
                writer.write_bool(last)?;
                writer.write_u16(length)?;
                writer.write_all(&value[0..length as usize])?;
            },
            Payload::CoreMgmtReply { succeeded } => {
    ...
    pub fn expects_response(&self) -> bool {
        ...
        match self {
            Payload::DmaAddTraceReply { .. } | Payload::DmaRemoveTraceReply { .. } |
                ...
                Payload::SubkernelFinished { .. } | Payload::CoreMgmtDropLinkAck { .. } |
                Payload::InjectionRequest { .. } => false,
            _ => true
        }
    }
}
